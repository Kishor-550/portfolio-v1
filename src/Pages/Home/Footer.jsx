	...
	return (
		<footer className="footer--container">
			<div className="footer--link--container">
				<div>
					<img src="./img/Kishor.png" width={"180px"} alt="Logoipsum" />
				</div>
				<div className="footer--items">
					<ul>
						...
						<li>
							<Link activeClass="navbar--active-content" spy={true} smooth={true} offset={-70} duration={500} to="AboutMe" className="text-md">
								About Me
							</Link>
						</li>
						<li>
							<Link activeClass="navbar--active-content" spy={true} smooth={true} offset={-70} duration={500} to="Contact" className="text-md">
								Contact
							</Link>
						</li>
						<li>
				...
				<div className="footer--social--icon">
					<ul>
						<li>
							<a href="mailto:kishor.muruganandham@gmail.com" className="navbar--content" target="_blank" rel="noreferrer">
								<svg
						...
						<li>
							<a
								href="https://instagram.com/kishor.muruganandham?utm_source=qr&igshid=MThlNWY1MzQwNA=="
						...
						<li>
							<a href="https://x.com/kishor_550?t=rlCFE6AQWFwuMqz3xyY6tA&s=08" className="navbar--content" target="_blank" rel="noreferrer">
								<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 33 33" fill="none">
									<path
						...
						<li>
							<a href="www.linkedin.com/in/kishor-muruganandham" className="navbar--content" target="_blank" rel="noreferrer">
								<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 33 33" fill="none">
									<path
										fill-rule="evenodd"
										clip-rule="evenodd"
			...
			<div className="footer--content--container">
				<p className="footer--content">Made with 💖 by Kishor</p>
				<div className="footer--social--icon">
					<ul>
						<li>
							<Link
